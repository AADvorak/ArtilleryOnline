...
export const DateUtils = {
  ...
  getClientDate(serverDate: string) {
    ...
    const serverOffset = settingsStore.timeZoneOffset || 0
  ...
  getClientDateLocaleTimeString(serverDate: string) {
    return this.getClientDate(serverDate).toLocaleTimeString()
  },
