import type { VehicleAcceleration } from '@/data/common'
import type { RoomModel, VehicleModel } from '@/data/model'
import type { VehicleCalculations, WheelCalculations } from '@/data/calculations'
import { VehicleUtils } from '@/utils/vehicle-utils'
import { VectorUtils } from '@/utils/vector-utils'
import { GroundPositionCalculator } from '@/battle/calculator/wheel/ground-position-calculator'
import { GroundStateCalculator } from '@/battle/calculator/wheel/ground-state-calculator'
import { EngineAccelerationCalculator } from '@/battle/calculator/wheel/engine-acceleration-calculator'
import { GroundFrictionAccelerationCalculator } from '@/battle/calculator/wheel/ground-friction-acceleration-calculator'
import { GroundReactionAccelerationCalculator } from '@/battle/calculator/wheel/ground-reaction-acceleration-calculator'
import { GravityAccelerationCalculator } from '@/battle/calculator/wheel/gravity-acceleration-calculator'
